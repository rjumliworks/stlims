...
<body>
    <table>
        <thead style="background-color:#c8c8c8; padding: 5px; font-size: 9px;">
            <tr>
                <td style="width: 300px; text-align: center; font-weight: bold;">id</td>
        ...
        @foreach($lists as $list)
            <tr style="text-align: center; font-size: 9px; color: #072388;">
                <td style="text-align: center; background-color: {{ ($list['status'] === 'Suspended') ? '#f5ac9f' : '' }};" >{{$list['id']}}</td>
                ...
                <td style="text-align: center; background-color: {{ ($list['status'] === 'Suspended') ? '#f5ac9f' : '' }};">{{$list['code']}}</td>
