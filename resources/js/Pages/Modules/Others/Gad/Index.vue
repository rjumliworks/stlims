<template>
  <div class="auth-page-wrapper d-flex flex-column">
    <div class="auth-page-content" style="background-color: #a88cd3;">
            ...
            <div class="col-lg-7">
              <div class="row">
                ...
                <template v-for="card in cards" :key="card.id">
                  <div
                    class="col-md-6"
                    :class="{ 'col-md-12': selectedCard === card.id }"
                    v-show="!selectedCard || selectedCard === card.id"
                        ...
                        <div class="card-body">
                          <div class="d-flex flex-wrap" style="cursor: pointer;">
                            ...
                            <div class="ms-3 mt-1">
                              ...
                              <h5 class="mb-0 text-muted fs-12">{{ card.subtitle }}</h5>
                            </div>
                          </div>
      ...
      cards: [
        {
          ...
          subtitle: 'Web Application System',
        ...
        },
        {
          ...
          subtitle: 'Department of Science and',
...
.sparkles span:nth-child(1) { top: 10%; left: 40%; animation-delay: 0s; }
.sparkles span:nth-child(2) { top: 50%; left: 85%; animation-delay: 0.5s; }
.sparkles span:nth-child(3) { top: 80%; left: 40%; animation-delay: 1s; }
.sparkles span:nth-child(4) { top: 60%; left: 10%; animation-delay: 1.5s; }
.sparkles span:nth-child(5) { top: 25%; left: 78%; animation-delay: 2s; }
