            ...
            <div class="row p-4" style="margin-top: -75px" v-if="id">
                    ...
                    <div class="card border">
                        <div class="card-body">
                            <div class="d-flex flex-wrap" style="cursor: pointer;">
                                ...
                                <div class="ms-3 mt-1">
                                    <p class="fw-semibold fs-15 text-purple text-truncated mb-0">Organizational Chart</p>
                                    <h5 class="mb-0 text-muted fs-13">View the structure and hierarchy of the DOST IX RSTL office.</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="content-bar">
                        <img src="/images/gad-org.png" class="img-fluid" alt="Responsive image">
                    </div>
                </div>
            </div>
        </div>
