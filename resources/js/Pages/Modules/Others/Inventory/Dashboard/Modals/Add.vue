<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 600px;" header-class="p-3 bg-light" title="Add Stocks" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
