                        ...
                        <table class="table align-middle table-centered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="ribbon-box" v-for="(list,index) in lists" v-bind:key="index" @click="selectRow(index)" 
                                    ...
                                    <td class="text-end">
                                        <a :href="`/testrequests/${list.qr}`" target="_blank">
                                        ...
                                        <b-button @click="openEdit(list.id,index)" variant="primary" v-b-tooltip.hover title="Save" size="sm">
                                            <i class="ri-save-fill align-bottom"></i> 
                                        </b-button>
                                    </td>
                                </tr>
                            </tbody>
...
export default {
    ...
    methods: {
        ...
        fetch(page_url){
            page_url = page_url || '/testrequests';
            axios.get(page_url,{
                params : {
        ...
        openPrint(id){
            window.open('/testrequests?option=print&id='+id);
        },
        updateData(data){
        ...
        moveTo(data){
            this.fetch();
            window.open(`/testrequests/${data}`, '_blank');
        },
    }
}
</script>