<template>
    <Head title="Receipts"/>
    <PageHeader title="Laboratories Receipts" pageTitle="List" />
                ...
                <table class="table table-nowrap align-middle mb-0">
                    <thead class="table-light">
                        <tr class="fs-11">
                            ...
                            <th style="width: 12%;" class="text-center">User</th>
                    ...
                    <tbody>
                        <tr v-for="(list,index) in lists" v-bind:key="index">
                            ...
                            <td class="text-center fs-11">{{list.created}}</td>
                            <!-- <td class="text-center">
                            ...
                            <td class="text-end">
                                ...
                                <b-button @click="openPrint(list.or_id)" variant="soft-success" class="me-1" v-b-tooltip.hover title="Print" size="sm">
