        ...
        <div class="card-header bg-light-subtle">
            <div class="d-flex mb-n3">
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-0 fs-14"><span class="text-body">{{year}} Monthly Financial Overview</span></h5>
                    <p class="text-muted text-truncate-two-lines fs-12">Total cost of services availed by gender (Woman and Woman-led), Value of assistance during women's month and VAWC celebration (March and October).</p>
                </div>
            </div>
        </div>
