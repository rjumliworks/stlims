        ...
        <div class="card-header bg-light-subtle">
            <div class="d-flex mb-n3">
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-0 fs-14"><span class="text-body">Breakdown</span></h5>
                    <p class="text-muted text-truncate-two-lines fs-12">Shows the consolidated and warm bodies count</p>
                </div>
                    ...
                    <table class="table align-middle table-centered table-nowrap mb-3">
                        <thead class="bg-white fs-11 thead-fixed">
                            <tr>
                                ...
                                <th class="text-center" style="width: 20%;">Consolidated</th>
                                <th class="text-center" style="width: 20%;">Warmbodies</th>
                            </tr>
                        </thead>
                        <tbody class="fs-12">
                            <tr v-for="(list,index) in breakdowns" v-bind:key="index">
                                <td>{{index + 1}}</td>
                                <td>{{list.name}}</td>
