<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 650px;" hide-footer title="Customer by Discount" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered>
                ...
                <div class="card-header bg-light-subtle">
                    <b-col lg>
                        <div class="input-group mb-1">
                            ...
                            <input type="text" placeholder="Search" class="form-control" style="width: 5%;">
