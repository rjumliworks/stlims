<template>
    <b-modal v-model="showModal" hide-footer title="Customer Top Spender" class="v-modal-custom" modal-class="zoomIn" size="lg" centered>
        <div class="row mb-4">
            <b-col class="mb-2" lg>
                <div class="input-group mb-1">
                   ...
                   <input type="tet" v-model="filter.keyword" placeholder="Search Customer" class="form-control" style="width: 45%">
                    ...
                    <b-button @click="openTop('spender')" type="button" variant="primary">
