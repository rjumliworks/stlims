<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 850px;" hide-footer title="Customer by Industry" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" size="lg" centered>
                ...
                <div class="card-header bg-light-subtle">
                    <b-col lg>
                        <div class="input-group mb-1">
                            ...
                            <Multiselect class="white" :options="months" style="width: 25%;" v-model="month" label="name" :allow-empty="false" :searchable="true" placeholder="Select Month" />
                            <Multiselect class="white" :options="years" style="width: 25%;" v-model="year" label="name" :searchable="true" placeholder="Select Year" />
