        ...
        <div class="card-header bg-light-subtle">
            <div class="d-flex mb-n3">
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-0 fs-14"><span class="text-body">Laboratories Offering Discounts</span></h5>
                    <p class="text-muted text-truncate-two-lines fs-12">Shows laboratories providing discounted services</p>
                </div>
            </div>
        </div>
        <div class="card-body">
...
export default {
    ...
    computed: {
        total() {
            return this.discounts.reduce((sum, item) => sum + parseFloat(item.total), 0);
        }
    },
    methods: {
        percentage(data){
