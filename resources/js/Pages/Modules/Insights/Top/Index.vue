    ...
    <b-row class="g-2 mb-2 mt-n2">
        <b-col lg>
            <div class="input-group mb-1">
                ...
                <Multiselect class="white" style="width: 17%;" :options="types" v-model="laboratory" label="name" :allow-empty="false" :searchable="true" placeholder="Select Laboratory" />
                ...
                <Multiselect class="white" style="width: 12%;" :options="years" v-model="year" label="name" :searchable="true" placeholder="Select Year" />
