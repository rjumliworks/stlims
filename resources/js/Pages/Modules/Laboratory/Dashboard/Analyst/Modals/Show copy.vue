<template>
    <b-modal v-model="showModal" :title="selected.code"  style="--vz-modal-width: 1200px;" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>    
        <div class="row mb-2">
            <div class="col-sm-4">
                        ...
                        <table class="table table-nowrap align-middle mb-0">
                            <thead class="table-light thead-fixed">
                                <tr class="fs-11">
                                    ...
                                    <th class="text-center" width="12%">Analyst</th>
                                    <th class="text-end" width="12%"></th>
                                </tr>
                            </thead>
                            <tbody>
