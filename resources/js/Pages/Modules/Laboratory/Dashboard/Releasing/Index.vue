                ...
                <div class="col-md-3">
                    <div class="card shadow-none border">
                        <div class="card-header bg-light-subtle">
                            <div class="d-flex mb-n3">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="mb-0 fs-14"><span class="text-body">Release Tracking</span></h5>
                                    <p class="text-muted text-truncate-two-lines fs-12">To ensure efficient delivery to customers</p>
                                </div>
                        ...
                        <div class="card-body border-bottom bg-white">
                            <p class="mb-0 text-primary fs-12 fw-semibold">TSR Release Summary</p>
                        </div>
