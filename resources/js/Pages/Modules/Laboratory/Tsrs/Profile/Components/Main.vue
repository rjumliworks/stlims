                                    ...
                                    <tr :class="(showAnalyses) ? 'bg-info-subtle' : ''">
                                        ...
                                        <td width="7%" class="text-end">
                                            <template v-if="showAnalyses">
                                                <b-button v-if="selected.status.name == 'Pending' || selected.status.name == 'For Payment' || selected.payment.discounted.name == 'Gratis'" @click="openSampleEdit(list)" variant="soft-primary" class="me-1" v-b-tooltip.hover title="Edit" size="sm">
