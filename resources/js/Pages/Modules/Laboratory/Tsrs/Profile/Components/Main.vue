                                    ...
                                    <tr :class="(showAnalyses) ? 'bg-info-subtle' : ''">
                                        ...
                                        <td width="7%" class="text-end">
                                            <template v-if="showAnalyses">
                                                <b-button v-if="selected.status.name == 'Pending' || selected.status.name == 'For Payment' || selected.has_parent || selected.payment.status.name == 'Gratis' || selected.is_onsite" @click="openSampleEdit(list)" variant="soft-primary" class="me-1" v-b-tooltip.hover title="Edit" size="sm">
                                                ...
                                                <b-button v-if="selected.status.name == 'Completed'" @click="openReport(list)" variant="soft-primary" v-b-tooltip.hover title="View Report" size="sm">
                                            ...
                                            <template v-else>
                                                 <b-button @click="openSampleView(list)" variant="soft-info" class="me-1" v-b-tooltip.hover title="View" size="sm">
...
export default {
    ...
    methods: { 
        ...
        openSampleView(data){
            console.log(data);
            this.$refs.sampleview.show(data);
        },
        openSampleEdit(data){
