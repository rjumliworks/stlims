<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 600px;" header-class="p-3 bg-light" title="Additional Service" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
